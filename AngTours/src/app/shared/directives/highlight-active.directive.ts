import { AfterViewInit, Directive, ElementRef, EventEmitter, Input, Output, OnChanges, OnInit, SimpleChanges } from '@angular/core';
...
export class HighlightActiveDirective implements AfterViewInit, OnInit, OnChanges{
  ...
  ngAfterViewInit(): void {
    setTimeout(()=>{
      this.items = this.el ? Array.from((this.el.nativeElement as HTMLElement).querySelectorAll(this.selector)):null;
